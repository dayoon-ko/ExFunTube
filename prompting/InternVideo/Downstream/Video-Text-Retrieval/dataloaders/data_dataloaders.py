...
from dataloaders.dataloader_videohumor_retrieval import VideoHumor_DataLoader
...
def dataloader_videohumor_retrieval(args, tokenizer, subset="test"):
    
    videohumor_testset = VideoHumor_DataLoader(
        video_dir=args.video_dir,
        caption_filename=args.caption_filename,
        segmentation_filename=args.segmentation_filename,
        tokenizer=tokenizer
    )
    dataloader_videohumor = DataLoader(
        videohumor_testset,
        batch_size=args.batch_size_val,
        num_workers=args.num_thread_reader,
        shuffle=False,
    ...
    return dataloader_videohumor, len(dataloader_videohumor)
...
DATALOADER_DICT["videohumor"] = {"train":None, "val":None, "test":dataloader_videohumor_retrieval}